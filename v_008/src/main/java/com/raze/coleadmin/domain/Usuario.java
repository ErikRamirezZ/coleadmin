...
public abstract class Usuario {
	...
	public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("correoE", "nombre", "primerApellido", "segundoApellido", "domicilio", "ciudad", "telefono", "fechaNacimiento", "foto", "contentType", "idUsuario", "fechaCreacion", "fechaModificacion", "activo");
