...
public class DocenteController {
    ...
    public String create(@Valid Docente docente, BindingResult bindingResult, Model uiModel, 
        ...
        uiModel.asMap().clear();
        docente.setContentType(multipartFile.getContentType());
        docenteService.saveDocente(docente);
    ...
    public String showImage(@PathVariable("id") Long id, HttpServletResponse response, Model model) {
        Docente logItem = (Docente) Docente.findUsuario(id);
        if (logItem != null) {
