...
public class PadreDataOnDemand {
	...
	public void setCiudad(Padre obj, int index) {
        String ciudad = "ciudad_" + index;
        obj.setCiudad(ciudad);
    }

	public void setContentType(Padre obj, int index) {
	...
	public void setDomicilio(Padre obj, int index) {
	...
	public void setIdUsuario(Padre obj, int index) {
	...
	public void setPlantel(Padre obj, int index) {
	...
	public void setTelefono(Padre obj, int index) {
