...
public class PersonalDataOnDemand {
	...
	public void setCiudad(Personal obj, int index) {
        String ciudad = "ciudad_" + index;
        obj.setCiudad(ciudad);
    }

	public void setContentType(Personal obj, int index) {
	...
	public void setDomicilio(Personal obj, int index) {
	...
	public void setIdUsuario(Personal obj, int index) {
	...
	public void setPlantel(Personal obj, int index) {
	...
	public void setTelefono(Personal obj, int index) {
