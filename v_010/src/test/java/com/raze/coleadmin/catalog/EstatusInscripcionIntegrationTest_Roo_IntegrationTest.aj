...
import com.raze.coleadmin.catalog.EstatusInscripcionIntegrationTest;
...
privileged aspect EstatusInscripcionIntegrationTest_Roo_IntegrationTest {
    
    declare @type: EstatusInscripcionIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: EstatusInscripcionIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: EstatusInscripcionIntegrationTest: @Transactional;
    
    @Autowired
    EstatusInscripcionDataOnDemand EstatusInscripcionIntegrationTest.dod;
    
    @Autowired
    EstatusInscripcionService EstatusInscripcionIntegrationTest.estatusInscripcionService;
    
    @Autowired
    EstatusInscripcionRepository EstatusInscripcionIntegrationTest.estatusInscripcionRepository;
    
    @Test
    public void EstatusInscripcionIntegrationTest.testCountAllEstatusInscripcions() {
    ...
    @Test
    public void EstatusInscripcionIntegrationTest.testFindEstatusInscripcion() {
    ...
    @Test
    public void EstatusInscripcionIntegrationTest.testFindAllEstatusInscripcions() {
        Assert.assertNotNull("Data on demand for 'EstatusInscripcion' failed to initialize correctly", dod.getRandomEstatusInscripcion());
        long count = estatusInscripcionService.countAllEstatusInscripcions();
    ...
    @Test
    public void EstatusInscripcionIntegrationTest.testFindEstatusInscripcionEntries() {
        Assert.assertNotNull("Data on demand for 'EstatusInscripcion' failed to initialize correctly", dod.getRandomEstatusInscripcion());
        long count = estatusInscripcionService.countAllEstatusInscripcions();
    ...
    @Test
    public void EstatusInscripcionIntegrationTest.testSaveEstatusInscripcion() {
        Assert.assertNotNull("Data on demand for 'EstatusInscripcion' failed to initialize correctly", dod.getRandomEstatusInscripcion());
    ...
    @Test
    public void EstatusInscripcionIntegrationTest.testDeleteEstatusInscripcion() {
        EstatusInscripcion obj = dod.getRandomEstatusInscripcion();
        Assert.assertNotNull("Data on demand for 'EstatusInscripcion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'EstatusInscripcion' failed to provide an identifier", id);
