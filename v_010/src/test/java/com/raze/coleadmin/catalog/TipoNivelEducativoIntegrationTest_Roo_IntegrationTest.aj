...
import com.raze.coleadmin.catalog.TipoNivelEducativoIntegrationTest;
...
privileged aspect TipoNivelEducativoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TipoNivelEducativoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TipoNivelEducativoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TipoNivelEducativoIntegrationTest: @Transactional;
    
    @Autowired
    TipoNivelEducativoDataOnDemand TipoNivelEducativoIntegrationTest.dod;
    
    @Autowired
    TipoNivelEducativoService TipoNivelEducativoIntegrationTest.tipoNivelEducativoService;
    
    @Autowired
    TipoNivelEducativoRepository TipoNivelEducativoIntegrationTest.tipoNivelEducativoRepository;
    
    @Test
    public void TipoNivelEducativoIntegrationTest.testCountAllTipoNivelEducativoes() {
    ...
    @Test
    public void TipoNivelEducativoIntegrationTest.testFindTipoNivelEducativo() {
    ...
    @Test
    public void TipoNivelEducativoIntegrationTest.testFindAllTipoNivelEducativoes() {
        Assert.assertNotNull("Data on demand for 'TipoNivelEducativo' failed to initialize correctly", dod.getRandomTipoNivelEducativo());
        long count = tipoNivelEducativoService.countAllTipoNivelEducativoes();
    ...
    @Test
    public void TipoNivelEducativoIntegrationTest.testFindTipoNivelEducativoEntries() {
        Assert.assertNotNull("Data on demand for 'TipoNivelEducativo' failed to initialize correctly", dod.getRandomTipoNivelEducativo());
        long count = tipoNivelEducativoService.countAllTipoNivelEducativoes();
    ...
    @Test
    public void TipoNivelEducativoIntegrationTest.testSaveTipoNivelEducativo() {
        Assert.assertNotNull("Data on demand for 'TipoNivelEducativo' failed to initialize correctly", dod.getRandomTipoNivelEducativo());
    ...
    @Test
    public void TipoNivelEducativoIntegrationTest.testDeleteTipoNivelEducativo() {
        TipoNivelEducativo obj = dod.getRandomTipoNivelEducativo();
        Assert.assertNotNull("Data on demand for 'TipoNivelEducativo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoNivelEducativo' failed to provide an identifier", id);
