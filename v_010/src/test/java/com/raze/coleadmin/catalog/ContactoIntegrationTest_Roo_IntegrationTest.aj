...
import com.raze.coleadmin.catalog.ContactoIntegrationTest;
...
privileged aspect ContactoIntegrationTest_Roo_IntegrationTest {
    ...
    declare @type: ContactoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    ...
    @Autowired
    ContactoService ContactoIntegrationTest.contactoService;
    
    @Autowired
    ContactoRepository ContactoIntegrationTest.contactoRepository;
    
    @Test
    public void ContactoIntegrationTest.testCountAllContactoes() {
    ...
    @Test
    public void ContactoIntegrationTest.testFindContacto() {
    ...
    @Test
    public void ContactoIntegrationTest.testFindAllContactoes() {
        Assert.assertNotNull("Data on demand for 'Contacto' failed to initialize correctly", dod.getRandomContacto());
        long count = contactoService.countAllContactoes();
    ...
    @Test
    public void ContactoIntegrationTest.testFindContactoEntries() {
        Assert.assertNotNull("Data on demand for 'Contacto' failed to initialize correctly", dod.getRandomContacto());
        long count = contactoService.countAllContactoes();
    ...
    @Test
    public void ContactoIntegrationTest.testSaveContacto() {
        Assert.assertNotNull("Data on demand for 'Contacto' failed to initialize correctly", dod.getRandomContacto());
    ...
    @Test
    public void ContactoIntegrationTest.testDeleteContacto() {
        Contacto obj = dod.getRandomContacto();
        Assert.assertNotNull("Data on demand for 'Contacto' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Contacto' failed to provide an identifier", id);
