...
import com.raze.coleadmin.catalog.ConceptoIntegrationTest;
...
privileged aspect ConceptoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ConceptoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ConceptoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ConceptoIntegrationTest: @Transactional;
    
    @Autowired
    ConceptoDataOnDemand ConceptoIntegrationTest.dod;
    
    @Autowired
    ConceptoService ConceptoIntegrationTest.conceptoService;
    
    @Autowired
    ConceptoRepository ConceptoIntegrationTest.conceptoRepository;
    
    @Test
    public void ConceptoIntegrationTest.testCountAllConceptoes() {
    ...
    @Test
    public void ConceptoIntegrationTest.testFindConcepto() {
    ...
    @Test
    public void ConceptoIntegrationTest.testFindAllConceptoes() {
        Assert.assertNotNull("Data on demand for 'Concepto' failed to initialize correctly", dod.getRandomConcepto());
        long count = conceptoService.countAllConceptoes();
    ...
    @Test
    public void ConceptoIntegrationTest.testFindConceptoEntries() {
        Assert.assertNotNull("Data on demand for 'Concepto' failed to initialize correctly", dod.getRandomConcepto());
        long count = conceptoService.countAllConceptoes();
    ...
    @Test
    public void ConceptoIntegrationTest.testSaveConcepto() {
        Assert.assertNotNull("Data on demand for 'Concepto' failed to initialize correctly", dod.getRandomConcepto());
    ...
    @Test
    public void ConceptoIntegrationTest.testDeleteConcepto() {
        Concepto obj = dod.getRandomConcepto();
        Assert.assertNotNull("Data on demand for 'Concepto' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Concepto' failed to provide an identifier", id);
