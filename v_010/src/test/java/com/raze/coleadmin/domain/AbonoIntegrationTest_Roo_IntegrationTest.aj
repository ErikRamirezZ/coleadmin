...
import com.raze.coleadmin.domain.AbonoIntegrationTest;
...
privileged aspect AbonoIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    AbonoService AbonoIntegrationTest.abonoService;
    
    @Autowired
    AbonoRepository AbonoIntegrationTest.abonoRepository;
    
    @Test
    public void AbonoIntegrationTest.testCountAllAbonoes() {
    ...
    @Test
    public void AbonoIntegrationTest.testSaveAbono() {
        Assert.assertNotNull("Data on demand for 'Abono' failed to initialize correctly", dod.getRandomAbono());
    ...
    @Test
    public void AbonoIntegrationTest.testDeleteAbono() {
        Abono obj = dod.getRandomAbono();
        Assert.assertNotNull("Data on demand for 'Abono' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Abono' failed to provide an identifier", id);
