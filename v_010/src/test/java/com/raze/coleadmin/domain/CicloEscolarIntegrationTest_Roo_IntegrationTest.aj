...
import com.raze.coleadmin.domain.CicloEscolarIntegrationTest;
...
privileged aspect CicloEscolarIntegrationTest_Roo_IntegrationTest {
    
    declare @type: CicloEscolarIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: CicloEscolarIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: CicloEscolarIntegrationTest: @Transactional;
    
    @Autowired
    CicloEscolarDataOnDemand CicloEscolarIntegrationTest.dod;
    
    @Autowired
    CicloEscolarService CicloEscolarIntegrationTest.cicloEscolarService;
    
    @Autowired
    CicloEscolarRepository CicloEscolarIntegrationTest.cicloEscolarRepository;
    
    @Test
    public void CicloEscolarIntegrationTest.testCountAllCicloEscolars() {
    ...
    @Test
    public void CicloEscolarIntegrationTest.testFindCicloEscolar() {
    ...
    @Test
    public void CicloEscolarIntegrationTest.testFindAllCicloEscolars() {
        Assert.assertNotNull("Data on demand for 'CicloEscolar' failed to initialize correctly", dod.getRandomCicloEscolar());
        long count = cicloEscolarService.countAllCicloEscolars();
    ...
    @Test
    public void CicloEscolarIntegrationTest.testFindCicloEscolarEntries() {
        Assert.assertNotNull("Data on demand for 'CicloEscolar' failed to initialize correctly", dod.getRandomCicloEscolar());
        long count = cicloEscolarService.countAllCicloEscolars();
    ...
    @Test
    public void CicloEscolarIntegrationTest.testSaveCicloEscolar() {
        Assert.assertNotNull("Data on demand for 'CicloEscolar' failed to initialize correctly", dod.getRandomCicloEscolar());
    ...
    @Test
    public void CicloEscolarIntegrationTest.testDeleteCicloEscolar() {
        CicloEscolar obj = dod.getRandomCicloEscolar();
        Assert.assertNotNull("Data on demand for 'CicloEscolar' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CicloEscolar' failed to provide an identifier", id);
