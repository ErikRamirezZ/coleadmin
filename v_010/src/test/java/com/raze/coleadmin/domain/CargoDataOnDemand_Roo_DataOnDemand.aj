...
privileged aspect CargoDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    AlumnoDataOnDemand CargoDataOnDemand.alumnoDataOnDemand;
    
    @Autowired
    ConceptoDataOnDemand CargoDataOnDemand.conceptoDataOnDemand;
    
    @Autowired
    EstatusCargoDataOnDemand CargoDataOnDemand.estatusCargoDataOnDemand;
    
    @Autowired
    CargoService CargoDataOnDemand.cargoService;
    
    @Autowired
    CargoRepository CargoDataOnDemand.cargoRepository;
    ...
    public void CargoDataOnDemand.setActivo(Cargo obj, int index) {
        Boolean activo = Boolean.TRUE;
        obj.setActivo(activo);
    }
    
    public void CargoDataOnDemand.setAlumno(Cargo obj, int index) {
        Alumno alumno = alumnoDataOnDemand.getRandomAlumno();
        obj.setAlumno(alumno);
    }
    
    public void CargoDataOnDemand.setCantidad(Cargo obj, int index) {
        Double cantidad = new Integer(index).doubleValue();
        obj.setCantidad(cantidad);
    }
    
    public void CargoDataOnDemand.setConcepto(Cargo obj, int index) {
        Concepto concepto = conceptoDataOnDemand.getRandomConcepto();
        obj.setConcepto(concepto);
    }
    
    public void CargoDataOnDemand.setDescuentoPesos(Cargo obj, int index) {
        Double descuentoPesos = new Integer(index).doubleValue();
        obj.setDescuentoPesos(descuentoPesos);
    }
    
    public void CargoDataOnDemand.setDescuentoPorcentaje(Cargo obj, int index) {
    ...
    public void CargoDataOnDemand.setSubtotal(Cargo obj, int index) {
        Double subtotal = new Integer(index).doubleValue();
        obj.setSubtotal(subtotal);
    }
    
    public void CargoDataOnDemand.setTotal(Cargo obj, int index) {
        Double total = new Integer(index).doubleValue();
        obj.setTotal(total);
    }
    
    public void CargoDataOnDemand.setUsuarioCrea(Cargo obj, int index) {
        Usuario usuarioCrea = null;
        obj.setUsuarioCrea(usuarioCrea);
    }
    
    public void CargoDataOnDemand.setUsuarioModifica(Cargo obj, int index) {
