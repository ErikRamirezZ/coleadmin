...
import com.raze.coleadmin.domain.GrupoIntegrationTest;
...
privileged aspect GrupoIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    GrupoService GrupoIntegrationTest.grupoService;
    
    @Autowired
    GrupoRepository GrupoIntegrationTest.grupoRepository;
    
    @Test
    public void GrupoIntegrationTest.testCountAllGrupoes() {
    ...
    @Test
    public void GrupoIntegrationTest.testSaveGrupo() {
        Assert.assertNotNull("Data on demand for 'Grupo' failed to initialize correctly", dod.getRandomGrupo());
    ...
    @Test
    public void GrupoIntegrationTest.testDeleteGrupo() {
        Grupo obj = dod.getRandomGrupo();
        Assert.assertNotNull("Data on demand for 'Grupo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Grupo' failed to provide an identifier", id);
