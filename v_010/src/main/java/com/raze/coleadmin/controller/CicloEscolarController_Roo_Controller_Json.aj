...
privileged aspect CicloEscolarController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> CicloEscolarController.showJson(@PathVariable("id") Long id) {
    ...
    @ResponseBody
    public ResponseEntity<String> CicloEscolarController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        try {
    ...
    public ResponseEntity<String> CicloEscolarController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> CicloEscolarController.createFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String> CicloEscolarController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            CicloEscolar cicloEscolar = CicloEscolar.fromJsonToCicloEscolar(json);
    ...
    public ResponseEntity<String> CicloEscolarController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            CicloEscolar cicloEscolar = cicloEscolarService.findCicloEscolar(id);
