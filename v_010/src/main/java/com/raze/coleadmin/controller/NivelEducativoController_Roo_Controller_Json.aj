...
privileged aspect NivelEducativoController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> NivelEducativoController.showJson(@PathVariable("id") Long id) {
    ...
    @ResponseBody
    public ResponseEntity<String> NivelEducativoController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        try {
    ...
    public ResponseEntity<String> NivelEducativoController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> NivelEducativoController.createFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String> NivelEducativoController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            NivelEducativo nivelEducativo = NivelEducativo.fromJsonToNivelEducativo(json);
    ...
    public ResponseEntity<String> NivelEducativoController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            NivelEducativo nivelEducativo = nivelEducativoService.findNivelEducativo(id);
