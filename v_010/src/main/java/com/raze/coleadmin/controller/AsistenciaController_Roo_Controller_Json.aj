...
privileged aspect AsistenciaController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> AsistenciaController.showJson(@PathVariable("id") Long id) {
    ...
    @ResponseBody
    public ResponseEntity<String> AsistenciaController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        try {
    ...
    public ResponseEntity<String> AsistenciaController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> AsistenciaController.createFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String> AsistenciaController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Asistencia asistencia = Asistencia.fromJsonToAsistencia(json);
    ...
    public ResponseEntity<String> AsistenciaController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Asistencia asistencia = asistenciaService.findAsistencia(id);
