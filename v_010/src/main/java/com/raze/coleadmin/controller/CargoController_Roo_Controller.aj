...
privileged aspect CargoController_Roo_Controller {
    ...
    @Autowired
    AlumnoService CargoController.alumnoService;
    
    @Autowired
    ConceptoService CargoController.conceptoService;
    
    @Autowired
    CargoService CargoController.cargoService;
    
    @Autowired
    EstatusCargoService CargoController.estatusCargoService;
    
    @Autowired
    UsuarioService CargoController.usuarioService;
