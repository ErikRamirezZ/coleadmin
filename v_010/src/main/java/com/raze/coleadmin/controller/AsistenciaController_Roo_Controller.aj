...
import com.raze.coleadmin.controller.AsistenciaController;
...
privileged aspect AsistenciaController_Roo_Controller {
    
    @Autowired
    AlumnoService AsistenciaController.alumnoService;
    
    @Autowired
    TipoAsistenciaService AsistenciaController.tipoAsistenciaService;
    
    @Autowired
    AsistenciaService AsistenciaController.asistenciaService;
    
    @Autowired
    UsuarioService AsistenciaController.usuarioService;
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String AsistenciaController.create(@Valid Asistencia asistencia, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AsistenciaController.createForm(Model uiModel) {
    ...
    public String AsistenciaController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String AsistenciaController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
    ...
    public String AsistenciaController.update(@Valid Asistencia asistencia, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, asistencia);
    ...
    public String AsistenciaController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, asistenciaService.findAsistencia(id));
        return "asistencias/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AsistenciaController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void AsistenciaController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void AsistenciaController.populateEditForm(Model uiModel, Asistencia asistencia) {
    ...
    String AsistenciaController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
