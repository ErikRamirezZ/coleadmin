...
@RooWebJson(jsonObject = Pago.class)
@Controller
@RequestMapping("/pagoes")
@RooWebScaffold(path = "pagoes", formBackingObject = Pago.class)
public class PagoController {
	...
	void addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("pago_fechacargo_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
